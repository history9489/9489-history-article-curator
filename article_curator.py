...
import time # Added for the countdown dismiss timer
                ...
                if resource_url and resource_description:
                    if gc:
                        try:
                            ...
                            # Temporal Success Alert container
                            success_slot = st.empty()
                            success_slot.success("Successfully logged aligned parameters into your Google Sheet backend columns!")
                            time.sleep(10)  # Message stays visible for 10 seconds
                            success_slot.empty()  # It vanishes beautifully!
